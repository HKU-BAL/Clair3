...
def mergeNonVariant(args):
    ...
    if(args.gvcf_fn ==None):
        ...
        gvcf_generator.mergeCalls(raw_vcf_path,raw_gvcf_path,save_path,args.sampleName,args.ctgName,args.ctgStart, args.ctgEnd)
...
def main():
    ...
    parser.add_argument('--qual', type=int, default=0,
                        help="If set, variant with lower quality will be Marked as LowQual")
    ...
    parser.add_argument('--non_var_gvcf_fn',default=None,help='path of non-variant gvcf')
