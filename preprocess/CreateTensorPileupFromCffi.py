...
def CreateTensorPileup(args):
    ...
    if args.tensor_can_fn != "PIPE":
        if len(all_position_info) == 0:
            print(logging.info(
                "[INFO] Total processed positions in {} (chunk {}/{}) : 0".format(args.ctgName, chunk_id, chunk_num,)))
        ...
        print(logging.info("[INFO] Total processed positions in {} (chunk {}/{}) : {}".format(args.ctgName, chunk_id, chunk_num, len(all_position_info))))
        return None, None, None
