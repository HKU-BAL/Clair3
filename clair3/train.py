...
def main():
    ...
    parser.add_argument('--bin_fn', type=str, default="", required=True,
                        help="Binary tensor input generated by Tensor2Bin.py, support multiple bin reader using pytables")
    ...
    parser.add_argument('--add_indel_length', type=int, default=0,
                        help="EXPERIMENTAL: Add indel length for training and calling, default true for full alignment")

    parser.add_argument('--pileup', action='store_true',
                        help="EXPERIMENTAL: In pileup training mode or not (full alignment), default: False")
