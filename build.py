...
htslib_dir = os.path.join(
    file_directory, "samtools-{}".format(samver), "htslib-{}".format(samver)
)
...
if platform.machine() in {"aarch64", "arm64"}:
    ...
    try:
        ...
        print(
            "[WARNING] Conda prefix not found, please activate clair3 conda environment first!\n"
        )
...
if __name__ == "__main__":
    ...
    run(
        "cp {}/libclair3*.so {}/libclair3.so".format(file_directory, file_directory),
        shell=True,
    )
