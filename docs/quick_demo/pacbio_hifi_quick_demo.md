...
Here is a quick demo for the PacBio HiFi variant calling using GIAB HG003 chromosome 20 data. We provide a Mamba/Conda virtual environment (**without root privileges**) and docker pre-built image (**with root privileges**) quick demo.
